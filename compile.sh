...
if [[ $archive == "1" ]]; then
    ...
    BYTECOIN_NAME="ento"
    WINDOWS_BUILD_DIR="$BYTECOIN_NAME-windows"
    MAC_BUILD_DIR="$BYTECOIN_NAME-mac"
    LINUX_BUILD_DIR="$BYTECOIN_NAME-linux"
    ...
    case "$OSTYPE" in
        msys*)
            ...
            cp ../build/release/src/Release/${BYTECOIN_NAME}d.exe ${WINDOWS_BUILD_DIR}/
        ...
        darwin*)
            ...
            rm -rf ${MAC_BUILD_DIR}
            mkdir ${MAC_BUILD_DIR}
            cp ../build/release/src/${BYTECOIN_NAME}d ${MAC_BUILD_DIR}/
        ...
        *)
            ...
            cp ../build/release/src/${BYTECOIN_NAME}d ${LINUX_BUILD_DIR}/
